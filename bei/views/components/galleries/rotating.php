...
echo '<div id="rotating__content" class="rotating__content col-12 col-md-8 carousel slide carousel-fade" data-ride="carousel">'.PHP_EOL;
if ($ri_images) {
	...
	echo '</div>'.PHP_EOL;
	echo '<a class="carousel-control-prev rotating__nav rotating__nav--prev" href="#rotating__slides" role="button" data-slide="prev"><img src="'.get_template_directory().'/sprites/chevron.svg'.'" alt="" class="img-fluid rotating__nav--img"><span class="sr-only">Previous</span></a>'.PHP_EOL;
	echo '<a class="carousel-control-next rotating__nav rotating__nav--next" href="#rotating__slides" role="button" data-slide="next"><img src="'.get_template_directory().'/sprites/chevron.svg'.'" alt="" class="img-fluid rotating__nav--img"><span class="sr-only">Next</span></a>'.PHP_EOL;
