...
echo '<span class="col-12 col-md-6 tabbed__pane--img">'.PHP_EOL;
echo '<img src="https://via.placeholder.com/1000x707" alt="" class="img-fluid">'.PHP_EOL;
echo '</span>'.PHP_EOL;
echo '<span class="col-12 col-md-6 tabbed__pane--content">'.PHP_EOL;
echo '</span>'.PHP_EOL;
echo '</div>'.PHP_EOL;
