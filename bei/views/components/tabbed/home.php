...
echo '<span class="col-12 col-md-6 tabbed__pane--img"><img src="https://via.placeholder.com/1000x707" alt="" class="img-fluid"></span>'.PHP_EOL;
echo '<span class="col-12 col-md-6 tabbed__pane--content"></span>'.PHP_EOL;
echo '</div>'.PHP_EOL;
