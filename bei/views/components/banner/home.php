...
echo '<figure class="carousel-item banner__slide active">'.PHP_EOL;
...
echo '<figcaption class="banner__caption d-flex h-100 align-items-center">'.PHP_EOL;
...
echo '</figure>'.PHP_EOL;
echo '<figure class="carousel-item banner__slide">'.PHP_EOL;
echo '<img src="https://demo.goodlayers.com/kingster/wp-content/uploads/2018/08/slider-1-2.jpg" alt="" class="img-fluid banner__image">'.PHP_EOL;
echo '<figcaption class="banner__caption d-flex h-100 align-items-center">'.PHP_EOL;
