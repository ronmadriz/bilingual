...
if (have_rows('icons')) {
	...
	while (have_rows('icons')) {
		...
		// echo '<img class="icons__img" src="'.get_stylesheet_directory_uri().'/sprites/'.$icons_icon.'.svg" alt="'.$icons_icon.'" class="img-fluid">'.PHP_EOL;
		echo file_get_contents(get_stylesheet_directory_uri().'/sprites/'.$icons_icon.'.svg');
