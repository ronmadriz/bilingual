<?php
// Used on Program simple_tables
if (have_rows('simple_table')) {
	echo '<section id="simple_table" class="simple_table">'.PHP_EOL;
	echo '<div class="container-fluid">'.PHP_EOL;
	while (have_rows('simple_table')) {
		the_row();
		$simple_table_section_title = get_sub_field('section_title');
