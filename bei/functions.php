...
function enqueue_my_scripts() {
	...
	wp_enqueue_script('device-js', get_template_directory_uri().'/assets/dist/scripts/device.min.js', array('jquery'), true, true);
...
function my_acf_init() {
	...
	acf_update_setting('google_api_key', 'AIzaSyBKyxUTBIi417EOtul3rMdnB56aJ6A_w5A');
}
